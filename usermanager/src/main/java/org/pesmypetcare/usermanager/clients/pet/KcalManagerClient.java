...
import org.pesmypetcare.usermanager.datacontainers.pet.Kcal;
import org.pesmypetcare.usermanager.datacontainers.pet.KcalData;
...
public class KcalManagerClient {
    private static final String BASE_URL = BuildConfig.URL + "kcal/";
